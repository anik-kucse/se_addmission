...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2017 at 03:28 PM
...
ALTER TABLE `unit_prosedure_status`
  ...
  ADD CONSTRAINT `unit_prosedure_status_ibfk_2` FOREIGN KEY (`unit_procedure_list_id`) REFERENCES `unit_procedure_list` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
